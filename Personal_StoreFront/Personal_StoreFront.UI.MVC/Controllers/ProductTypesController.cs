...
namespace Personal_StoreFront.UI.MVC.Controllers
{
    public class ProductTypesController : Controller
    {
        ...
        public ProductTypesController(Personal_StoreFrontContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("TypeId,ProductType1,ProductTypeDescription")] ProductType productType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TypeId,ProductType1,ProductTypeDescription")] ProductType productType)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Personal_StoreFrontContext.ProductTypes'  is null.");
            }
            var productType = await _context.ProductTypes.FindAsync(id);
            if (productType != null)
            {
